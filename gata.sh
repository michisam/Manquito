...
if wget -q https://github.com/Ancelbot/Sexi/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git https://github.com/Ancelbot/Sexi.git
...
echo -e "\033[01;32m\033[01mIniciando Ancelsiñho!!\nStarting CatBot!!\n\033[0m"
npm start
